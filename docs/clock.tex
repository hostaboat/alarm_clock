...
device if switched \sOff{f} via the \cPo{f} switch.  If the time is incorrect
when switching the device \sOn{f}, the battery may need replacement.  For more
