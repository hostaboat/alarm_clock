...
\begin{tabu} { X[1,c,m] | X[1,c,m] | X[4,l,m] }
  ...
  \mTSDe{sym} & \sDl{dEF.!} & Reload default touch sensitivity and
...
To disable touch, from the \sTSMe{f}, select the \mTSDi{f} menu option which
is shown on the \cDi{f} as \symD{OFF!} and \textit{will} be blinking.

\as{{ c c c c c }}{\sTSMe{sym} & \sTu & \eSel{sym}{} \mTSDi{sym} & \sPR & \sTSDi{sym} \\}
