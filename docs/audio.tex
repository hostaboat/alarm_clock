...
\begin{longtabu}{ X[1,c,m] | X[4,l,m] }
  ...
  \sPlay
    & Press \& release \thinspace\sPl\enspace when the \mAu{f} is in the
      \sAuPa{f} or \sAuSt{f} state. \\ \drule{2}
  \sPause
    & Press \& release \thinspace\sPl\enspace when the \mAu{f} is in the
      \sAuPl{f} state. \\ \drule{2}
  \sStop
    & Press \& hold \thinspace\sPl\enspace when the \mAu{f} is in the \sAuPl{f}
      or \sAuPa{f} state until \symD{StOP} is displayed then release. \\ \drule{2}
  \sNext
