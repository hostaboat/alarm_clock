...
\ers{2}
  \begin{tabu}{ X[1,c,m] | X[1,c,m] | X[1,c,m] | X[1,c,m] }  
    \thrule
    \multicolumn{4}{c}{\thLb{Positions \& Modes}} \\ \mrule
...
on the \cTo{f} of the enclosure.  See \hyperref[Touch Settings]{\mTS{f}} for
more information on configuring and calibrating the \cTS{f}.
