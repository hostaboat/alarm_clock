...
\aTo{f} can also be used to show the current track.  From \sClTi{f}, \sClMD{f}
...
this to work - see \hyperref[Touch Settings]{\mTS{ss}} for more information.}
...
\aTo{f} can also be used to display the current track from \sClTi{f}, \sClMD{f}
...
most of your fingers lay across the top of the enclosure.}
