...
one state - \sSNCI{f} - when taking this path before finishing.
...
\begin{itemize}
  \item Setting all three to \mono{FF} will give you \textit{white}.
  \item Setting all three to \mono{00} will give you \textit{black}.  This can
    be utilized in \mCl{f} mode so you can \aTu{f} the \cEs{f} instead of having
    to \aPR{f} the \cEs{f} to turn the night light off.
...
may take an extra turn or two to come back on after the \cDi{f} has
turned on.}
...
\begin{enumerate}
  \item \aPR{f} the \cEs{f} to cache the value and move on to \sSNBl{f}, or
  \item \aDC{f} the \cEs{f} to set, save and finish.
\end{enumerate}
...
\begin{enumerate}
\item \aPR{f} the \cEs{f} to cache the value and cycle back to \sSNRe{f}, or
\item \aDC{f} the \cEs{f} to set, save and finish.
\end{enumerate}
...
\begin{itemize}
  ...
  \item Try not to change the \sSNBr{f} from \mono{FF} since the
    brightness is adjustable via the \cBr{f} and may desync the \cLi{f} and
    \cDi{f}.
...
\info{Depending on the values set, there may be some desyncing between the
\cDi{f} and \cLi{f} at low brightness levels.  This is because given different
values for the pixels, they may drop out before the \cDi{f} turns off and may
take an extra turn or two to come back on after the \cDi{f} has turned on.}
...
\begin{enumerate}
  \item \aPR{f} the \cEs{f} to cache the value and move on to \sSNSa{f}, or
  \item \aDC{f} the \cEs{f} to set, save and finish.
\end{enumerate}
...
\begin{enumerate}
  \item \aPR{f} the \cEs{f} to cache the value and move on to \sSNBr{f}, or
  \item \aDC{f} the \cEs{f} to set, save and finish.
\end{enumerate}
...
\begin{enumerate}
  \item \aPR{f} the \cEs{f} to cache the value and cycle back to \sSNHu{f}, or
  \item \aDC{f} the \cEs{f} to set, save and finish.
\end{enumerate}
...
back to \sSNMN{f}, \aPR{f} the \cEs{f}.
