...
\newcommand{\aWT}[1]{%
\ifthenelse{\equal{#1}{sym}}{\symTGA{red}{white}{WAKE TIME EXCEEDED}}{\fontTGA{#1}{WAKE TIME EXCEEDED}}}
\newcommand{\aTT}[1]{%
\ifthenelse{\equal{#1}{sym}}{\symTGA{red}{white}{TOTAL ALARM TIME EXCEEDED}}{\fontTGA{#1}{TOTAL ALARM TIME EXCEEDED}}}
\newcommand{\aST}[1]{%
...
\newcommand{\aside}[1]{%
\begin{center}
\par\medskip\rule{\textwidth}{1pt}
{\parbox[c]{6.6in}{\par\medskip #1 \par\medskip}}
\par\rule{\textwidth}{1pt}\end{center}\par\medskip}
...
{\raisebox{-1mm}{\includegraphics{images/danger.png}} #1}%
\end{minipage}}\end{center}}

\newcommand{\warning}[1]{\begin{center}\fbox{%
\begin{minipage}{0.92\textwidth}%
{\raisebox{-1mm}{\includegraphics{images/warning.png}} #1}%
\end{minipage}}\end{center}}

\newcommand{\info}[1]{\begin{center}\fbox{%
\begin{minipage}{0.92\textwidth}%
{\raisebox{-1mm}{\includegraphics{images/info.png}} #1}%
\end{minipage}}\end{center}}

%\newcommand{\info}[1]{%
%\fbox{\parbox{\textwidth}{\raisebox{-1mm}{\includegraphics{images/info.png}} #1}}}

%\newcommand{\steps}[2]{\fbox{%
%\begin{minipage}{0.95\textwidth}\par\medskip%
%{\parbox{\textwidth}{\centering \thbi{#1}}} \newline #2%
%\end{minipage}}}

\newcommand{\steps}[2]{\begin{center}\fbox{%
\begin{minipage}{0.92\textwidth}\par\medskip%
{\parbox{\textwidth}{\centering \thbi{#1}}} \newline #2%
\end{minipage}}\end{center}}

%\newcommand{\ssteps}[3]{%
%\fbox{\parbox{#1\textwidth}{\parbox{#1\textwidth}{\centering \thbi{#2}} \newline #3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tabu}{X[1,l,m] X[1,r,m]}
  %\fontTGA{h}{\bfseries Boogie Box}
  \fontTGA{h}{\bfseries \project{}}
    & \fontTGA{ss}{Designed and Assembled by Todd Wease} \\
\end{tabu}
\end{table}
...
\begin{tabu}{X[1,l,m] X[1,l,m]}
  \multirow{4}{*}{\includegraphics{images/alarm_clock.png}}
